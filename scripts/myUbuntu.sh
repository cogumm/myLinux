...
echo "LOG:"
echo "  28-04-13 => CoGUMm  - Atualizado alguns pacotes"
echo "  29-04-13 => CoGUMm  - Atualizado alguns pacotes, adicionado a instalação do Ruby, RoR e Sublime2"
echo "  14-10-15 => CoGUMm  - Atualizado vários pacores, adicionado a instalação Telegram, Wine e Popcorn Time"
echo "  16-10-15 => CoGUMm  - Adicionado Spotify"
